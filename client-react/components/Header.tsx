...
export class Header extends React.Component<RouteComponentProps<any>, any> {
    ...
    render() {
        ...
        return <nav className="navbar navbar-toggleable-md navbar-inverse bg-inverse fixed-top">
            ...
            <Link className="navbar-brand logo-color" to={RoutePaths.Employees}>HELP+</Link>
            
            <div className="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul className="navbar-nav mr-auto">
                    <li className="nav-item active">
                        <Link className="nav-link" to={RoutePaths.Employees}>Employees</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link" to={RoutePaths.Contacts}>Payroll</Link>
                    </li>
                    {/* <li className="nav-item">
